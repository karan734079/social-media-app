        ...
        <div className="flex flex-col sm:flex-row items-center sm:justify-between sm:space-x-8">
          <div className="relative">
            <img
              ...
              alt="Profile"
              className="rounded-full h-40 w-40 object-cover border-4 border-gray-300"
            />
            <div className="absolute bottom-4 right-1 bg-red-600 text-white w-8 h-8 text-center rounded-full">
            <button
              onClick={handleChangePhotoClick}
              className="text-2xl"
            >
        ...
        {showChangePhoto && (
          <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
            <div className="bg-white p-8 rounded-lg shadow-lg w-1/3">
              <h2 className="text-xl font-semibold mb-4">Upload New Profile Photo</h2>
              <input
                type="file"
                onChange={handlePhotoChange}
