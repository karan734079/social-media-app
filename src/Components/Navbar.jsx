...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white  p-4 justify-between w-[15%] shadow-lg h-screen space-y-10 cursor-pointer fixed">
            ...
            <div className='flex space-x-2 p-3 text-center space-y-6 transition-transform transform hover:scale-105' onClick={handleLogOut}><img src={logoutIcon} alt="" className='h-8 w-8 mt-6' /><p className='text-xl'>Logout</p></div>
        </nav>
    );
}
